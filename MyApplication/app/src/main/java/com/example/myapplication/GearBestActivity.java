...
public class GearBestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gearbest);
        ...
        final WebView web_view = findViewById(R.id.web_view_gearbest);
        ...
        web_view.loadUrl("https://br.gearbest.com/");
