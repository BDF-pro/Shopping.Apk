...
public class BanggoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final WebView web_view = findViewById(R.id.web_view_banggood);
        ...
        web_view.loadUrl("https://br.banggood.com/");
